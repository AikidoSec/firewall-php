...
In Forge, go to your server -> `Settings` -> `Environment` and add the `AIKIDO_TOKEN` in the .env file. Optionally, you can set `AIKIDO_BLOCK` to 1 to enabling blocking mode for attacks.
