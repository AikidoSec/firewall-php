--TEST--
Test IDOR protection blocks PDOStatement::execute() INSERT that sets the wrong tenant ID value
...
$stmt = $pdo->prepare("INSERT INTO cats (name, tenant_id) VALUES (:name, :tenant_id)");
$stmt->execute([':name' => 'Mittens', ':tenant_id' => 'org_456']);
