--TEST--
Test IDOR protection resolves pg_query_params() values with the default connection
...
$result = pg_query_params('SELECT name FROM cats WHERE tenant_id = $1', ['org_123']);
