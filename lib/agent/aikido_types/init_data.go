...
func NewServerData() *ServerData {
	return &ServerData{
		...
		AttackWaveIpQueues:      make(map[string]*AttackWaveQueue, 1024),
		AttackWaveLastSent:      make(map[string]time.Time, 1024),
		AttackWaveLastSeen:      make(map[string]time.Time, 1024),
	}
}
