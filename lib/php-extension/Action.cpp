...
ACTION_STATUS Action::executeThrow(json &event) {
    ...
    // Set response code BEFORE throwing: exception triggers header flush which reads http_response_code from SAPI. (This works for both standard and frankenphp.)
