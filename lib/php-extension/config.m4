...
if test "$PHP_AIKIDO" != "no"; then
  ...
  PHP_NEW_EXTENSION(aikido, Aikido.cpp GoWrappers.cpp PhpWrappers.cpp PhpLifecycle.cpp Stats.cpp Server.cpp Environment.cpp RequestProcessor.cpp Agent.cpp Hooks.cpp Utils.cpp Handle.cpp HandleUrls.cpp HandleUsers.cpp HandleShouldBlockRequest.cpp Cache.cpp HandleFileCompilation.cpp HandleShellExecution.cpp Log.cpp HandlePDO.cpp HandlePathAccess.cpp InsertASTCall.cpp Action.cpp, $ext_shared)
fi
