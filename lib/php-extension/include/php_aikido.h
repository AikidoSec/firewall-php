...
#define PHP_AIKIDO_VERSION "1.5.4"
...
bool block_invalid_sql; // Block SQL queries that fail tokenization when user input is present (AIKIDO_BLOCK_INVALID_SQL, default: false)
