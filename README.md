...
* Check that you have a supported PHP version installed (PHP version >= 7.0 and tested up to 8.4).
...
### PHP versions
Zen for PHP supports the following PHP versions: 7.0, 7.1, 7.2, 7.3, 7.4, 8.0, 8.1, 8.2, 8.3, 8.4.
