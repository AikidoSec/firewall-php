...
```
rpm -Uvh --oldpackage https://github.com/AikidoSec/firewall-php/releases/download/v1.0.115/aikido-php-firewall.x86_64.rpm
```

#### For Debian-based Systems (Debian, Ubuntu)

```
curl -L -O https://github.com/AikidoSec/firewall-php/releases/download/v1.0.115/aikido-php-firewall.x86_64.deb
